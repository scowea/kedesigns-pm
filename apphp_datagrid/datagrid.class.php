...
Class DataGrid
{
    ...
    protected function DrawControlPanel(){       
		...
		if ($_GET['q'] == 'node/1')
		{
			...
			echo '[<a href="'.$sorting_link.'1">--Only Active--</a>] ';
			echo '[<a href="'.$sorting_link.'2">--Only On Order--</a>] ';
	...
	// tweeking sort by that gets screwed up and drops the second sorting field
