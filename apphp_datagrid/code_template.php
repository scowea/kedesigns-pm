<?
    ...
    */
    ...
    ################################################################################
    ## --------------------------------------------------------------------------- #
    ##  PHP DataGrid Pro version 5.0.5                                             #
    ...
    ##  *** RELATIVE PATH ONLY ***
      ...
      define ("DATAGRID_DIR", "apphp_datagrid/");                     /* Ex.: "datagrid/" */ 
      define ("PEAR_DIR", "apphp_datagrid/pear/");                    /* Ex.: "datagrid/pear/" */
    ...
    ##  *** creating variables that we need for database connection 
      $DB_USER='sunpower_web';            /* usually like this: prefix_name             */
      $DB_PASS='test_password';           /* must be already encrypted (recommended)   */
      $DB_HOST='localhost';               /* usually localhost                          */
      $DB_NAME='sunnyday';                /* usually like this: prefix_dbName           */
    ...
    ##  *** write down the primary key in the first place
      $sql = "SELECT id, name, address FROM dealerships ;";
