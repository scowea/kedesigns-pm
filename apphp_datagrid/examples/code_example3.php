...
<html>
  <head>
    <title>PHP DataGrid :: Sample #3 (code)</title>
...
<td align="left"  height="100px"><pre>
    <h3>
    Sample 3. Advanced PHP DG code </h3><h4>
        1. All modes (Add/Edit/Details/Delete/View).
        2. All features.
        3. Two DataGrids on one page.
        4. Customized layout in details mode.</h4>    
...
##  *** set layouts: 0 - tabular(horizontal) - default, 1 - columnar(vertical) 
 ...
 $details_template = "
    ...
    <tr class='class_tr' bgcolor='#fcfaf6'> 
        ...
        <td width='50%'>
            <table border=0>
                <tr class='class_tr' bgcolor='#fcfaf6'><td class='default_dg_td class_left' nowrap><b>Region:</b> </td><td class='default_dg_td class_left' >{region_id}</td></tr>
                <tr class='class_tr' bgcolor='#fcfaf6'><td class='default_dg_td class_left' nowrap><b>Country:</b> </td><td class='default_dg_td class_left' >{name}</td></tr>
                <tr class='class_tr' bgcolor='#fcfaf6'><td class='default_dg_td class_left' nowrap><b>Independent date:</b> </td><td class='default_dg_td class_left' >{independent_date}</td></tr>
                <tr class='class_tr' bgcolor='#fcfaf6'><td class='default_dg_td class_left' nowrap><b>Democracy?</b> </td><td class='default_dg_td class_left' >{is_democracy}</td></tr>
                <tr class='class_tr' bgcolor='#fcfaf6'><td class='default_dg_td class_left' nowrap><b>Population:</b> </td><td class='default_dg_td class_left' >{population}</td></tr>
                <tr class='class_tr' bgcolor='#fcfaf6'><td class='default_dg_td class_left' nowrap><b>Description:</b> </td><td class='default_dg_td class_left' >{description}</td></tr>
            </table>
        </td>
    </tr>    
    </table>
    ...
    <tr class='class_tr' bgcolor='#ffffff' id='f_row_1' >    
        <th class='default_dg_th class_left'  bgColor='#e2e0cb'  wrap style='BORDER-RIGHT: #d2d0bb 0px solid;' >
            <div style='float:right;'>
                <a class='f_class_a' href='http://apphp.com/php-datagrid/examples/sample3_demo.php?skin=&amp;f_mode=cancel&amp;f_rid=236&amp;f_sort_field=1&amp;f_sort_type=DESC&amp;f_page_size=10&amp;f_p=1&amp;f_sort_field=1&amp;f_sort_type=DESC&amp;f_page_size=10&amp;f_p=1' title='Back'>Back</a>
            </div>
        </th>
    </tr>
    </table>
